...
function UserPage() {
    ...
    const [filterDepartmentId, setFilterDepartmentId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    ...
    const watchedRole = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$form$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Form$3e$__["Form"].useWatch("role", form);
    const watchedFacultyId = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$form$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Form$3e$__["Form"].useWatch("facultyId", form);
    const watchedDepartmentId = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$form$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Form$3e$__["Form"].useWatch("departmentId", form);
    ...
    const loadLookups = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถโหลดข้อมูลคณะ/ภาควิชาได้");
            console.error(error);
        }
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserPage.useEffect": ()=>{
            ...
            if (user?.role === "DEPT_STAFF") {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("คุณไม่มีสิทธิ์เข้าถึงเมนูจัดการผู้ใช้");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserPage.useEffect": ()=>{
            ...
            const loadMajors = {
                "UserPage.useEffect.loadMajors": async ()=>{
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$department$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMajorsByDepartment"])(watchedDepartmentId);
    ...
    const usersInTab = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "UserPage.useMemo[usersInTab]": ()=>users.filter({
                "UserPage.useMemo[usersInTab]": (user)=>TAB_ROLE_MAP[activeTab].includes(user.role)
            }["UserPage.useMemo[usersInTab]"])
    }["UserPage.useMemo[usersInTab]"], [
        users,
        activeTab
    ]);
    const filteredUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "UserPage.useMemo[filteredUsers]": ()=>{
            let data = [
                ...usersInTab
            ];
            if (search) {
                ...
                data = data.filter({
                    "UserPage.useMemo[filteredUsers]": (user)=>{
            ...
            if (filterDepartmentId) {
                data = data.filter({
                    "UserPage.useMemo[filteredUsers]": (user)=>user.departmentId === filterDepartmentId
                }["UserPage.useMemo[filteredUsers]"]);
            }
            return data;
        }
    ...
    const departmentOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "UserPage.useMemo[departmentOptions]": ()=>{
            if (!watchedFacultyId) return departments;
            return departments.filter({
                "UserPage.useMemo[departmentOptions]": (item)=>item.facultyId === watchedFacultyId
            }["UserPage.useMemo[departmentOptions]"]);
        }
    }["UserPage.useMemo[departmentOptions]"], [
        departments,
    ...
    const roleOptionsByTab = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "UserPage.useMemo[roleOptionsByTab]": ()=>{
    ...
    const defaultRoleByTab = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "UserPage.useMemo[defaultRoleByTab]": ()=>{
    ...
    const openEditModal = async (user)=>{
        ...
        if (role === "STUDENT" && values.departmentId) {
            try {
                const majorData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$department$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMajorsByDepartment"])(values.departmentId);
    ...
    const handleDelete = async (user)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteUser"])(user.id);
    ...
    const submitForm = async (values)=>{
        ...
        try {
            ...
            if (editingUser) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUser"])(editingUser.id, payload);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success("แก้ไขผู้ใช้สำเร็จ");
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUser"])(payload);
...
_s(UserPage, "h3/YjMXxU1z+MUrOn6uVXN0RK5E=", false, function() {
    return [
...
//# sourceMappingURL=src_42dcb0e1._.js.map