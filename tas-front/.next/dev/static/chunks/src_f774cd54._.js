...
"[project]/src/services/report.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const downloadDepartmentReport = async ()=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$apiClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/reports/department.xlsx", {
        responseType: "blob"
    });
    return response.data;
};
...
"[project]/src/app/teacher/report/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$report$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/report.js [app-client] (ecmascript)");
...
function TeacherReportPage() {
    ...
    const [studentsLoading, setStudentsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [evidenceFilesByUser, setEvidenceFilesByUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TeacherReportPage.useEffect": ()=>{
    ...
    const fetchActivities = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถโหลดกิจกรรมได้");
        } finally{
            setLoading(false);
        }
    };
    ...
    const transformedActivities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TeacherReportPage.useMemo[transformedActivities]": ()=>activities.map({
                "TeacherReportPage.useMemo[transformedActivities]": (activity)=>({
                        id: activity.id,
            ...
            }["TeacherReportPage.useMemo[transformedActivities]"])
    }["TeacherReportPage.useMemo[transformedActivities]"], [
        activities,
    ...
    const filteredActivities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TeacherReportPage.useMemo[filteredActivities]": ()=>{
            const query = searchQuery.trim().toLowerCase();
            if (!query) return transformedActivities;
            return transformedActivities.filter({
                "TeacherReportPage.useMemo[filteredActivities]": (activity)=>`${activity.activityName} ${activity.department} ${activity.major}`.toLowerCase().includes(query)
            }["TeacherReportPage.useMemo[filteredActivities]"]);
        }
    }["TeacherReportPage.useMemo[filteredActivities]"], [
    ...
    const fetchStudentsForActivity = async (activityId)=>{
        ...
        try {
            const [attendancesResponse, filesResponse] = await Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$attendance$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAttendancesByActivity"])(activityId),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$file$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFilesByActivity"])(activityId)
            ]);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถโหลดข้อมูลนักศึกษาได้");
        } finally{
    ...
    const handleDownloadEvidence = async (student)=>{
        ...
        if (!files.length) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].warning("ไม่พบไฟล์หลักฐานสำหรับนักศึกษานี้");
            return;
        }
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(`ดาวน์โหลดไฟล์ ${files.length} ไฟล์สำเร็จ`);
        } catch (error) {
            console.error("Error downloading evidence files:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถดาวน์โหลดไฟล์ได้");
        }
    };
    const handleExport = async ()=>{
        setExporting(true);
        try {
            const blob = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$report$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["downloadDepartmentReport"])();
            saveBlob(blob, "department-report.xlsx");
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success("ดาวน์โหลดรายงานสำเร็จ");
        } catch (error) {
            console.error("Error exporting department report:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถดาวน์โหลดรายงานได้");
        } finally{
            setExporting(false);
        }
    };
...
_s(TeacherReportPage, "iwtLaz1nfgRU9pbexDus1wGPst8=");
_c = TeacherReportPage;
var _c;
__turbopack_context__.k.register(_c, "TeacherReportPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_f774cd54._.js.map