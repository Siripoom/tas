...
function ParticipationPage() {
    ...
    const handleViewEvidence = async (record)=>{
        ...
        try {
            const files = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$file$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFilesByActivity"])(record.id);
    ...
    const handleReject = async (attendance)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success("ส่งกลับแก้ไขการเข้าร่วมสำเร็จ");
            fetchData(); // Refresh data
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถส่งกลับแก้ไขการเข้าร่วมได้");
    ...
    const handleRejectEvidence = async (attendance)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success("ส่งกลับแก้ไขหลักฐานสำเร็จ");
            fetchData(); // Refresh data
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถส่งกลับแก้ไขหลักฐานได้");
...
_s(ParticipationPage, "TRUT4Ym+xhGkEa5mNO7Pf0oRPzM=");
...
//# sourceMappingURL=src_7a223c3a._.js.map