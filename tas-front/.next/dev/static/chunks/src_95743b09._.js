...
"[project]/src/app/admin/activity-type/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ActivityTypePage() {
    ...
    const loadData = async ()=>{
        setLoading(true);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$typeActivity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllTypeActivities"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ActivityTypePage.useEffect": ()=>{
            const raw = localStorage.getItem("user");
            const user = raw ? JSON.parse(raw) : null;
            if (!managementRoles.includes(user?.role)) {
                setAccessDenied(true);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("คุณไม่มีสิทธิ์เข้าถึงเมนูประเภทกิจกรรม");
    ...
    const filteredItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ActivityTypePage.useMemo[filteredItems]": ()=>{
            const query = search.trim().toLowerCase();
            if (!query) return items;
            return items.filter({
                "ActivityTypePage.useMemo[filteredItems]": (item)=>String(item.code || "").toLowerCase().includes(query) || String(item.name || "").toLowerCase().includes(query)
            }["ActivityTypePage.useMemo[filteredItems]"]);
        }
    }["ActivityTypePage.useMemo[filteredItems]"], [
        items,
    ...
    const handleSubmit = async (values)=>{
        ...
        try {
            ...
            if (editingItem) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$typeActivity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateTypeActivity"])(editingItem.id, payload);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success("แก้ไขประเภทกิจกรรมสำเร็จ");
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$typeActivity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createTypeActivity"])(payload);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success("เพิ่มประเภทกิจกรรมสำเร็จ");
            }
    ...
    const handleDelete = async (item)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$typeActivity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteTypeActivity"])(item.id);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success("ลบประเภทกิจกรรมสำเร็จ");
            await loadData();
        } catch (error) {
...
_s(ActivityTypePage, "cDVPsDGTdgqnDryg5IKrTre1nx4=", false, function() {
    return [
...
_c = ActivityTypePage;
var _c;
__turbopack_context__.k.register(_c, "ActivityTypePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_95743b09._.js.map