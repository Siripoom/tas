...
function TeacherParticipationPage() {
    ...
    const handleApprove = (student)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(`Approved ${student.name}`);
    };
    const handleReject = (student)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(`Rejected ${student.name}`);
    };
    const handleApproveEvidence = (student)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(`Evidence approved for ${student.name}`);
    };
    const handleRejectEvidence = (student)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(`Evidence rejected for ${student.name}`);
    };
    const tabItems = [
        {
            key: "participation",
...
_s(TeacherParticipationPage, "+o26TtrEybG7l5kzwGvM+a2qO10=");
...
//# sourceMappingURL=src_2ef7773f._.js.map