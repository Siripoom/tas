...
function TeacherParticipationPage() {
    ...
    const fetchActivities = async ()=>{
        setLoading(true);
        try {
            const activitiesData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$activity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllActivities"])();
    ...
    const handleEdit = (record)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].info(`Edit activity: ${record.name}`);
    };
    const handleDelete = (record)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(`Deleted activity: ${record.name}`);
    };
    const handleApprove = async (student)=>{
        console.log(student);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$attendance$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateAttendance"])(student.id, {
                status: "accepted"
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(`อนุมัติ ${student.name} สำเร็จ`);
            fetchActivities(); // Refresh data
        } catch (error) {
            console.error("Error approving:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถอนุมัติได้");
        }
    };
    const handleReject = async (student)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(`ปฏิเสธ ${student.name}`);
            fetchActivities(); // Refresh data
        } catch (error) {
            console.error("Error rejecting:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถปฏิเสธได้");
        }
    };
    const handleApproveEvidence = async (student)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(`อนุมัติหลักฐานสำหรับ ${student.name} สำเร็จ`);
            fetchActivities(); // Refresh data
        } catch (error) {
    ...
    const handleRejectEvidence = async (student)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(`ปฏิเสธหลักฐานสำหรับ ${student.name}`);
            fetchActivities(); // Refresh data
        } catch (error) {
...
_s(TeacherParticipationPage, "/ZS7mlgQ5S1gh64TR44ofw4Bx64=");
...
//# sourceMappingURL=src_00b91986._.js.map