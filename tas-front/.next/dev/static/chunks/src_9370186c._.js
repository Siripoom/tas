...
function LoginPage() {
    ...
    const onFinish = async (values)=>{
        setLoading(true);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(values.email, values.password);
            // Store token
...
//# sourceMappingURL=src_9370186c._.js.map