...
const getAllTypeActivities = async ()=>{
    return DEFAULT_TYPE_ACTIVITIES;
};
const getTypeActivityById = async (id)=>{
    return DEFAULT_TYPE_ACTIVITIES.find((item)=>item.id === id) || null;
};
const createTypeActivity = async ()=>{
    throw new Error("Type activity CRUD is not exposed in this API build.");
};
const updateTypeActivity = async ()=>{
    throw new Error("Type activity CRUD is not exposed in this API build.");
};
...
//# sourceMappingURL=src_548d06f7._.js.map