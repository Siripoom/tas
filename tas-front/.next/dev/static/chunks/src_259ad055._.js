...
function AdminEventPage() {
    ...
    const watchedDepartmentIds = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$form$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Form$3e$__["Form"].useWatch("departmentIds", form);
    ...
    const [majorOptions, setMajorOptions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const loadMajorsByDepartments = async (departmentIds, keepCurrentSelection = true)=>{
        ...
        try {
            const allMajors = (await Promise.all(ids.map(async (departmentId)=>{
                try {
                    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$department$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMajorsByDepartment"])(departmentId);
                } catch (_error) {
                    return [];
                }
            }))).flat();
    ...
    const fetchData = async ()=>{
        ...
        try {
            ...
            const [activitiesData, typeData, departmentData] = await Promise.all([
                ...
                canListDepartments ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$department$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllDepartments"])() : Promise.resolve([])
            ]);
    ...
    const filteredEvents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminEventPage.useMemo[filteredEvents]": ()=>{
            const query = searchQuery.trim().toLowerCase();
            return events.filter({
                "AdminEventPage.useMemo[filteredEvents]": (event)=>{
                    if (scopedDepartmentId) {
                        const scopedDepartmentIds = new Set(toDepartmentList(event).map({
                            "AdminEventPage.useMemo[filteredEvents]": (item)=>item.id
                        }["AdminEventPage.useMemo[filteredEvents]"]));
                    ...
                    if (query) {
                        const departmentNames = toDepartmentList(event).map({
                            "AdminEventPage.useMemo[filteredEvents].departmentNames": (item)=>String(item?.name || "")
                        }["AdminEventPage.useMemo[filteredEvents].departmentNames"]).join(" ").toLowerCase();
                    ...
                    if (selectedDepartment) {
                        const departmentIds = new Set(toDepartmentList(event).map({
                            "AdminEventPage.useMemo[filteredEvents]": (item)=>item.id
                        }["AdminEventPage.useMemo[filteredEvents]"]));
    ...
    const summary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminEventPage.useMemo[summary]": ()=>({
                totalActivities: filteredEvents.length,
                totalHours: filteredEvents.reduce({
                    "AdminEventPage.useMemo[summary]": (sum, event)=>sum + Number(event.hour || event.hours || 0)
                }["AdminEventPage.useMemo[summary]"], 0)
            })
    }["AdminEventPage.useMemo[summary]"], [
        filteredEvents
    ]);
    ...
    const handleDelete = async (record)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(`ลบกิจกรรม "${record.name || record.title}" สำเร็จ`);
            await fetchData();
        } catch (error) {
    ...
    const handleSubmit = async (values)=>{
        ...
        try {
            ...
            if (editingEvent) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$activity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateActivity"])(editingEvent.id, payload);
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$activity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createActivity"])(payload);
    ...
    const departmentFilterOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminEventPage.useMemo[departmentFilterOptions]": ()=>{
            if (departments.length > 0) return departments;
            return uniqueById(events.flatMap({
                "AdminEventPage.useMemo[departmentFilterOptions]": (event)=>toDepartmentList(event)
            }["AdminEventPage.useMemo[departmentFilterOptions]"]));
        }
    }["AdminEventPage.useMemo[departmentFilterOptions]"], [
        departments,
...
_s(AdminEventPage, "uRxfJtocnW6aAXTO+uh9ExX2JCg=", false, function() {
    return [
...
_c = AdminEventPage;
var _c;
__turbopack_context__.k.register(_c, "AdminEventPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_259ad055._.js.map