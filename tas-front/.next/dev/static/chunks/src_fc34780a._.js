...
function TeacherHome() {
    ...
    const fetchData = async ()=>{
        setLoading(true);
        try {
            const [activitiesData, usersData, attendancesData] = await Promise.all([
    ...
    // กรองกิจกรรมตามภาควิชาของผู้ใช้
    const departmentActivities = activities.filter((activity)=>{
        const departments = getActivityDepartments(activity);
        if (userDepartmentId) {
            return departments.some((department)=>department.id === userDepartmentId);
        }
        if (userDepartment) {
            return departments.some((department)=>department.name === userDepartment);
        }
        return false;
    });
    ...
    const stats = [
        ...
        },
        {
            ...
            value: attendances.filter((att)=>att.status === "APPLIED" && departmentActivities.some((act)=>act.id === att.activityId)).length,
            icon: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$file$2d$text$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__FileText$3e$__["FileText"], {
                size: 24,
                style: {
                    color: "#086b3d"
        ...
        {
            title: "Active Events",
            value: departmentActivities.filter((act)=>act.status === "IN_PROGRESS").length,
            icon: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$activity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Activity$3e$__["Activity"], {
                size: 24,
                style: {
                    color: "#05c168"
    ...
    // จัดกลุ่มกิจกรรมตามประเภทกิจกรรม
...
_s(TeacherHome, "b/jFlxIx/pSatRyjRORhjBNlQ30=");
_c = TeacherHome;
var _c;
...
//# sourceMappingURL=src_fc34780a._.js.map