...
function TeacherParticipationPage() {
    ...
    const fetchActivities = async ()=>{
        setLoading(true);
        try {
            const activitiesData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$activity$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllActivities"])();
    ...
    const getFilteredData = ()=>{
        ...
        if (searchQuery) {
            ...
            filtered = filtered.filter((activity)=>activity.name?.toLowerCase().includes(query) || activity.department?.name?.toLowerCase().includes(query) || activity.typeActivity?.name?.toLowerCase().includes(query));
        }
        // Apply major filter
        if (filters.major) {
            filtered = filtered.filter((activity)=>activity.typeActivity?.name === filters.major);
        }
        return filtered;
    };
    ...
    const handleEdit = (record)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].info(`Edit activity: ${record.name}`);
    };
    const handleDelete = (record)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(`Deleted activity: ${record.name}`);
    };
    const handleApprove = async (student)=>{
        console.log(student);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$attendance$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateAttendance"])(student.id, {
                status: "accepted"
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(`อนุมัติ ${student.name} สำเร็จ`);
            fetchActivities(); // Refresh data
        } catch (error) {
            console.error("Error approving:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถอนุมัติได้");
        }
    };
    const handleReject = async (student)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(`ปฏิเสธ ${student.name}`);
            fetchActivities(); // Refresh data
        } catch (error) {
            console.error("Error rejecting:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถปฏิเสธได้");
        }
    };
    const handleApproveEvidence = async (student)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$attendance$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateAttendance"])(student.id, {
                status: "completed"
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(`อนุมัติหลักฐานสำหรับ ${student.name} สำเร็จ`);
            fetchActivities(); // Refresh data
        } catch (error) {
    ...
    const handleRejectEvidence = async (student)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$attendance$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateAttendance"])(student.id, {
                status: "uncompleted"
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(`ปฏิเสธหลักฐานสำหรับ ${student.name}`);
            fetchActivities(); // Refresh data
        } catch (error) {
            console.error("Error rejecting evidence:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถปฏิเสธหลักฐานได้");
        }
    };
    const tabItems = [
        {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$card$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Card$3e$__["Card"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "jsx-ddb748a2f4573329" + " " + "text-white",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                            className: "jsx-ddb748a2f4573329" + " " + "text-2xl font-bold mb-2",
                            children: [
                                "ภาควิชา ",
                                userDepartment
                            ]
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "jsx-ddb748a2f4573329" + " " + "text-sm opacity-90",
                            children: "จัดการการเข้าร่วมกิจกรรมและหลักฐานของนักศึกษาในภาควิชา"
                        }, void 0, false, {
                            fileName: "[project]/src/app/teacher/participation/page.js",
                            lineNumber: 273,
                            columnNumber: 11
...
//# sourceMappingURL=%5Broot-of-the-server%5D__33af3ac5._.js.map