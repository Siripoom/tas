...
"[project]/src/app/teacher/participation/page.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TeacherParticipationPage() {
    ...
    const majorOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const set = new Set();
    ...
    const filteredActivities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        return activities.filter((activity)=>{
            ...
            if (filters.major) {
                const hasMajor = (activity.majorJoins || []).some((item)=>item?.major?.name === filters.major);
                if (!hasMajor) return false;
            }
            if (filters.year) {
                const hasYear = (activity.attendances || []).some((attendance)=>String(attendance?.user?.level || "") === String(filters.year));
    ...
    const handleOpenEvidence = async (activity)=>{
        ...
        try {
            const files = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$file$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFilesByActivity"])(activity.id);
    ...
    const handleReject = async (attendance)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success("ส่งกลับแก้ไขสำเร็จ");
            await fetchActivities();
        } catch (error) {
            console.error("Error requesting revision:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถส่งกลับแก้ไขได้");
        }
    };
    const tabItems = [
        {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__95a40a60._.js.map