 ...
 */ "production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function hasUnfilteredFrame(request, stack) {
        ...
        for(var i = 0; i < stack.length; i++){
            ...
            if (!callsite[6] && request(url, functionName, lineNumber, columnNumber) && "" !== url) return !0;
        }
        return !1;
    }
    ...
    function visitAsyncNodeImpl(request, task, node, visited, cutOff) {
        ...
        if (null !== node.previous && (previousIONode = visitAsyncNode(request, task, node.previous, visited, cutOff), void 0 === previousIONode)) return;
        switch(node.tag){
            case 0:
                return node;
            case 3:
            ...
            case 1:
                var awaited = node.awaited, promise = node.promise.deref();
                if (null !== awaited) {
                    cutOff = visitAsyncNode(request, task, awaited, visited, cutOff);
                    if (void 0 === cutOff) break;
                    null !== cutOff ? previousIONode = 1 === cutOff.tag ? cutOff : null !== node.stack && hasUnfilteredFrame(request, node.stack) || void 0 !== promise && "string" === typeof promise.displayName && (null === cutOff.stack || !hasUnfilteredFrame(request, cutOff.stack)) ? node : cutOff : request.status === ABORTING && node.start < request.abortTime && node.end > request.abortTime && (null !== node.stack && hasUnfilteredFrame(request, node.stack) || void 0 !== promise && "string" === typeof promise.displayName) && (previousIONode = node);
                }
                void 0 !== promise && (node = promise._debugInfo, null == node || visited.has(node) || (visited.set(node, null), forwardDebugInfo(request, task, node)));
                return previousIONode;
            case 4:
                return previousIONode;
            case 2:
                ...
                if (null !== awaited) {
                    ...
                    if (null !== promise) {
                        ...
                        startTime < cutOff ? (previousIONode = promise, null !== node.stack && isAwaitInUserspace(request, node.stack) && void 0 !== (null === awaited.promise ? void 0 : awaited.promise.deref()) && serializeIONode(request, promise, awaited.promise)) : null !== node.stack && isAwaitInUserspace(request, node.stack) ? request.status === ABORTING && startTime > request.abortTime || (serializeIONode(request, promise, awaited.promise), visited.set(promise, null), null != node.owner && outlineComponentInfo(request, node.owner), cutOff = (0, request.environmentName)(), advanceTaskTime(request, task, startTime), request.pendingChunks++, emitDebugChunk(request, task.id, {
                            awaited: promise,
                            env: cutOff,
                            owner: node.owner,
                            stack: null === node.stack ? null : filterStackTrace(request, node.stack)
                        }), markOperationEndTime(request, task, endTime), request.status === ABORTING && (previousIONode = void 0)) : previousIONode = promise;
                    }
                }
                node = node.promise.deref();
                void 0 !== node && (node = node._debugInfo, null == node || visited.has(node) || (visited.set(node, null), forwardDebugInfo(request, task, node)));
                return previousIONode;
            default:
    ...
    function serializeIONode(request, ioNode, promiseRef) {
        ...
        if (null !== ioNode.promise) {
            ...
            void 0 !== promise && "string" === typeof promise.displayName && (name = promise.displayName);
        }
            ...
            if ("" === name) {
                a: {
                    ...
                    for(var i = 0; i < name.length; i++){
                        ...
                        if (callsite(url, functionName, callsite$jscomp$0[2], callsite$jscomp$0[3]) && "" !== url) {
                            if ("" === promise) {
                                name = functionName;
                                break a;
                            }
        ...
        emitIOInfoChunk(request, callsite$jscomp$0, name, ioNode.start, i, callsite, promiseRef, promise, existingRef);
            ...
            if ("number" === typeof info.time) markOperationEndTime(request$jscomp$0, task, info.time);
                ...
                if (!(ioInfo.end <= request$jscomp$0.timeOrigin)) {
                    ...
                    if (!request.writtenObjects.has(ioInfo$jscomp$0)) {
                        ...
                        null == env && (env = (0, request.environmentName)());
                        emitIOInfoChunk(request, id$jscomp$0, ioInfo$jscomp$0.name, ioInfo$jscomp$0.start, ioInfo$jscomp$0.end, ioInfo$jscomp$0.value, env, owner, debugStack);
                        request.writtenDebugObjects.set(ioInfo$jscomp$0, serializeByValueID(id$jscomp$0));
                    }
                    null != info.owner && outlineComponentInfo(request$jscomp$0, info.owner);
                    ...
                    ioInfo.env = null != info.env ? info.env : (0, request$jscomp$0.environmentName)();
    ...
    (function() {
        async_hooks.createHook({
            init: function(asyncId, type, triggerAsyncId, resource) {
                ...
                else if ("bound-anonymous-fn" === type || "Microtask" === type || "TickObject" === type || "Immediate" === type) {
                    if (void 0 === trigger) return;
                } else if (void 0 === trigger) trigger = resolveOwner(), trigger = {
                    tag: 0,
                    owner: trigger,
                ...
                else if (2 === trigger.tag || 4 === trigger.tag) resource = resolveOwner(), trigger = {
                    tag: 0,
                    owner: resource,
            ...
            before: function(asyncId) {
                ...
                if (void 0 !== node) switch(node.tag){
                    case 0:
                        lastRanAwait = null;
                        0 > node.end ? node.end = performance.now() : (node = {
                            tag: 0,
                            owner: node.owner,
                            stack: node.stack,
                            start: node.start,
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        resolvePromiseOrAwaitNode(node, performance.now()).previous = lastRanAwait;
                        lastRanAwait = null;
                        break;
                    default:
                        lastRanAwait = null;
...
//# sourceMappingURL=node_modules_next_dist_compiled_react-server-dom-turbopack_1f3e10cc._.js.map