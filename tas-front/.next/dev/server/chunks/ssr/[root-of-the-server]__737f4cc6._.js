...
const EvidenceListModal = ({ visible, onClose, activity, onApprove, onReject })=>{
    ...
    const getStudentsWithEvidence = ()=>{
        ...
        return activity.attendances.filter((attendance)=>[
                ...
                status: attendance.status === "COMPLETED" || attendance.status === "APPROVED" ? "approved" : attendance.status === "REJECTED" ? "rejected" : "pending"
            }));
    };
...
function ParticipationPage() {
    ...
    const handleReject = async (attendance)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(`ปฏิเสธการเข้าร่วมสำเร็จ`);
            fetchData(); // Refresh data
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("ไม่สามารถปฏิเสธการเข้าร่วมได้");
    ...
    const handleRejectEvidence = async (attendance)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(`ปฏิเสธหลักฐานสำเร็จ`);
            fetchData(); // Refresh data
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__737f4cc6._.js.map