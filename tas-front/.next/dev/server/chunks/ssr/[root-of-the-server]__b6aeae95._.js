...
"[project]/src/services/student.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getMyProgress = async ()=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/students/me/progress");
    return response.data;
};
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$student$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/student.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function StudentHomePage() {
    ...
    const loadData = async (user)=>{
        ...
        try {
            const [activitiesData, attendanceData, progressData] = await Promise.all([
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$attendance$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAttendancesByUser"])(user.id),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$student$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMyProgress"])()
            ]);
    ...
    const joinedActivityIds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>new Set(userAttendances.map((attendance)=>attendance.activityId)), [
        userAttendances
    ]);
    const eligibleActivities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>activities.filter((activity)=>isActivityEligibleForStudent(activity, userInfo)), [
        activities,
        userInfo
    ]);
    ...
    const handleConfirmJoin = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(`ลงทะเบียนกิจกรรม "${selectedActivity.name}" สำเร็จ`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b6aeae95._.js.map