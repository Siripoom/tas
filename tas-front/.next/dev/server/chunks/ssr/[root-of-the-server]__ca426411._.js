...
function TeacherHome() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const sessionScope = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sessionUser$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUserScope"])();
    ...
    const departmentActivities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>(Array.isArray(activities) ? activities : []).filter((activity)=>isInDepartmentScope(activity, scope?.departmentId)), [
        activities,
        scope?.departmentId
    ]);
    const uniqueStudentCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const ids = new Set();
    ...
    const pendingApprovals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>departmentActivities.reduce((sum, activity)=>{
            const pending = (activity.attendances || []).filter((attendance)=>[
                    "APPLIED",
                    "REVISION_REQUIRED"
                ].includes(attendance.status)).length;
            return sum + pending;
        }, 0), [
        departmentActivities
    ]);
    const activeEvents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>departmentActivities.filter((activity)=>activity.status === "IN_PROGRESS").length, [
        departmentActivities
    ]);
    const totalHours = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>departmentActivities.reduce((sum, activity)=>sum + Number(activity.hour || activity.hours || 0), 0), [
        departmentActivities
    ]);
    ...
    const recentActivities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>[
            ...departmentActivities
        ].sort((a, b)=>new Date(b.updatedAt || b.createdAt || b.startAt).getTime() - new Date(a.updatedAt || a.createdAt || a.startAt).getTime()).slice(0, 4), [
        departmentActivities
    ]);
    const stats = [
        {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ca426411._.js.map