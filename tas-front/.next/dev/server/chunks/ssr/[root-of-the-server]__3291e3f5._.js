...
const uploadFileAttendance = async (file, attendanceId)=>{
    ...
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/files/upload-attendance", formData, {
        headers: {
            "Content-Type": "multipart/form-data"
        }
    });
...
const downloadAttendanceFile = async (attendanceId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/files/attendance/${attendanceId}`, {
        responseType: "blob"
    });
    return response.data;
};
...
"[project]/src/app/admin/report/page.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ReportPage() {
    ...
    const fetchActivities = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("Failed to load activities");
        } finally{
            setLoading(false);
        }
    };
    ...
    const fetchStudentsForActivity = async (activityId)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("Failed to load student data");
        } finally{
    ...
    const getFilteredActivities = ()=>{
        ...
        return activities.filter((activity)=>activity.activityName.toLowerCase().includes(query) || activity.department.toLowerCase().includes(query) || activity.major.toLowerCase().includes(query));
    };
    ...
    const handleDownload = async (student)=>{
        try {
            ...
            if (files.length === 0) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].warning("No evidence files found for this student");
                return;
            }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(`Downloaded ${files.length} file(s) for ${student.name}`);
        } catch (error) {
            console.error("Error downloading files:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error("Failed to download files");
        }
    };
    const handlePrint = (student)=>{
      ...
      <body>
        ...
        <div class="info"><span class="label">Student ID:</span> ${student.studentId}</div>
        <div class="info"><span class="label">Name:</span> ${student.name}</div>
        <div class="info"><span class="label">Department:</span> ${student.department}</div>
        <div class="info"><span class="label">Major:</span> ${student.major}</div>
        <div class="info"><span class="label">Year:</span> ${student.year}</div>
        <div class="info"><span class="label">Activity:</span> ${selectedActivity?.activityName}</div>
        <div class="info"><span class="label">Participation Date:</span> ${student.participationDate}</div>
        <div class="info"><span class="label">Status:</span> ${student.status}</div>
        <div class="info"><span class="label">Evidence Files:</span> ${evidenceFiles[student.userId]?.length || 0} file(s)</div>
      </body>
      </html>
    `;
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$space$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__default__as__Space$3e$__["Space"], {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$button$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__$3c$export__default__as__Button$3e$__["Button"], {
                            ...
                            title: hasFiles ? `${evidenceFiles[record.userId].length} file(s)` : "No files",
                            children: "Download"
                        }, void 0, false, {
                            fileName: "[project]/src/app/admin/report/page.js",
                            lineNumber: 433,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "ดูรายงานกิจกรรมและการมีส่วนร่วมของนักศึกษาในแต่ละกิจกรรม"
                    }, void 0, false, {
                        fileName: "[project]/src/app/admin/report/page.js",
                        lineNumber: 476,
                        columnNumber: 9
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3291e3f5._.js.map